...
function templateEventPrefix()
{
    return "\n    protected " .'$_eventPrefix = self::CACHE_TAG;'."\n";
}

function templateEventObject($moduleName)
{
    return "\n    protected " .'$_eventObject = \''. strtolower($moduleName) .'\';'."\n";
}

function templateIdFieldName($moduleInfo, $modelName)
{
    $idFieldName = createDbIdFromModuleInfoAndModelShortName($moduleInfo, $modelName);
...
function createModelClass($moduleInfo, $modelName)
{
    ...
    $body                =
        ...
        templateEventObject($modelName) .
        templateIdFieldName($moduleInfo, $modelName) .
        $construct                      .
